...
function init() {
  ...
  if (sa) {
    try {
      var a = JSON.parse(sa);
      ['proxy', 'cid', 'cs', 'reg', 'realm', 'guild'].forEach(function (k) {
        var el = document.getElementById('cfg-' + k);
...
function loadDemo() {
  roster = [
    ...
    { name: 'Aeerys', realm: 'azralon', guild: 'Errow', class: 'Mage', spec: 'Frost', role: ROLE_DPS_RANGE, specId: 64, ilvl: 641, mythicRating: 1980, issues: ['Capa: Sem encantamento'], note: '', gear: {}, vault: { mythic: 4, raid: 7, world: 2 }, renderUrl: null, lastUpdated: new Date().toISOString() },
    { name: 'Doppel', realm: 'illidan', guild: 'Errow', class: 'Rogue', spec: 'Assassination', role: ROLE_DPS_MELEE, specId: 259, ilvl: 638, mythicRating: 1750, issues: ['Colar: Sem encantamento', 'Anel 1: Sem gema'], note: 'Cross-realm', gear: {}, vault: { mythic: 3, raid: 5, world: 0 }, renderUrl: null, lastUpdated: new Date().toISOString() },
    { name: 'Zaag', realm: 'azralon', guild: 'Errow', class: 'Warrior', spec: 'Arms', role: ROLE_DPS_MELEE, specId: 71, ilvl: 635, mythicRating: 1600, issues: ['Ombros: Sem encantamento'], note: '', gear: {}, vault: { mythic: 2, raid: 3, world: 1 }, renderUrl: null, lastUpdated: new Date().toISOString() },
    ...
    { name: 'Windrunner', realm: 'azralon', guild: 'Errow', class: 'Hunter', spec: 'Marksmanship', role: ROLE_DPS_RANGE, specId: 254, ilvl: 628, mythicRating: 1200, issues: ['Peitoral: Sem encantamento'], note: '', gear: {}, vault: { mythic: 1, raid: 2, world: 0 }, renderUrl: null, lastUpdated: new Date().toISOString() },
    ...
    { name: 'Darkbrew', realm: 'silvermoon', guild: 'Errow', class: 'Monk', spec: 'Windwalker', role: ROLE_DPS_MELEE, specId: 269, ilvl: 631, mythicRating: 1100, issues: ['Pulso: Sem encantamento'], note: 'Cross-realm', gear: {}, vault: { mythic: 3, raid: 4, world: 1 }, renderUrl: null, lastUpdated: new Date().toISOString() },
    { name: 'Níghtwólf', realm: 'azralon', guild: 'Errow', class: 'Demon Hunter', spec: 'Havoc', role: ROLE_DPS_MELEE, specId: 577, ilvl: 615, mythicRating: 620, issues: ['Mão Principal: Sem encantamento'], note: 'Trial', gear: {}, vault: { mythic: 0, raid: 1, world: 0 }, renderUrl: null, lastUpdated: new Date().toISOString() },

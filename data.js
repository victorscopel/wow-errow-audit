...
var I18N = {
  ...
  show_ilvl_decimal: { en: 'Show iLvl with Decimals', pt_BR: 'Exibir iLvl com decimais' },
  ...
  cfg_display: { en: 'Display', pt_BR: 'Exibição' },
  cfg_archon: { en: 'Meta Stats (Archon.gg)', pt_BR: 'Meta Stats (Archon.gg)' },
  cfg_archon_desc: { en: 'Stat priority by raid difficulty', pt_BR: 'Prioridade de atributos por dificuldade de raid' },
  ilvl_min: { en: 'Min iLvl', pt_BR: 'iLvl Mínimo' },
  ilvl_min_desc: { en: 'Highlight players below this iLvl', pt_BR: 'Destacar jogadores abaixo deste iLvl' },
  heroic: { en: 'Heroic', pt_BR: 'Heroico' },
  mythic_diff: { en: 'Mythic', pt_BR: 'Mítico' },
  meta_loading: { en: 'Loading meta stats…', pt_BR: 'Carregando meta stats…' },
  meta_no_data: { en: 'No meta data available.', pt_BR: 'Nenhum dado de meta disponível.' },
  no_perm: { en: 'You do not have permission to do this.', pt_BR: 'Você não tem permissão para isso.' },
  add_member: { en: 'Add Member', pt_BR: 'Adicionar Membro' },
  search_add: { en: '🔍 Search & Add', pt_BR: '🔍 Buscar e Adicionar' },
  realm_lbl: { en: 'Realm', pt_BR: 'Realm' },
  realm_placeholder_short: { en: 'azralon', pt_BR: 'azralon' },
  search_placeholder: { en: 'Search...', pt_BR: 'Buscar...' },
  member_removed: { en: 'Member removed.', pt_BR: 'Membro removido.' },
  member_added: { en: '{name} added!', pt_BR: '{name} adicionado!' },
  name_required: { en: 'Enter a name.', pt_BR: 'Digite um nome.' },
  no_data_short: { en: 'No data.', pt_BR: 'Sem dados.' },
  invalid_data: { en: 'Invalid.', pt_BR: 'Inválido.' },
  members_imported: { en: '{n} members imported.', pt_BR: '{n} membros importados.' },
  invalid_json: { en: 'Invalid JSON.', pt_BR: 'JSON inválido.' },
  data_cleared: { en: 'Data cleared.', pt_BR: 'Dados limpos.' },
  demo_loaded: { en: 'Demo loaded!', pt_BR: 'Demo carregado!' },
  note_for: { en: 'Note for {name}:', pt_BR: 'Nota para {name}:' },
